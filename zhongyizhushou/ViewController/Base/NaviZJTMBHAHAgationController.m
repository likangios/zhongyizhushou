//
//  NaviZJTMBHAHAgationController.m
//  CDDMall
//
...
@interface NaviZJTMBHAHAgationController ()



@end

@implementation NaviZJTMBHAHAgationController
...
+ (void)setUpBase
{
    ...
    attributes[NSFontAttributeName] = PFR16Font;
