...
#import "ZYTCaimiyuFirstListCtl.h"
#import "ZYTCaimiyuSecondListCtl.h"
#import "CaiMiYuListCell.h"

@interface ZYTCaimiyuFirstListCtl ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation ZYTCaimiyuFirstListCtl
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ZYTItemCountModel *model = self.dataArray[indexPath.row];
    cell.guanka.text = [NSString stringWithFormat:@"第%ld关",indexPath.row + 1];
    cell.guankaDet.text = [NSString stringWithFormat:@"%ld/50",[[ZYTDataBaseManage sharedDataBaseManage] getNumberOfUnlockItemListModelWithParentid:model.parentid]];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([model.isunlock isEqualToString:@"1"]) {
        model. isunlock = @"1";
        ZYTCaimiyuSecondListCtl *vc = [[ZYTCaimiyuSecondListCtl alloc]init];
